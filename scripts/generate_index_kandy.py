"""Generate Kandy BU index page with customer selector."""
import json
...
def generate_index_html(data):
    """Generate the Kandy BU index HTML."""
...
<head>
    ...
    <title>Kandy Customer Overview | Skyvera</title>
    ...
    <style>
        ...
        * {{ margin: 0; padding: 0; box-sizing: border-box; }}
        ...
        .header {{
            background: linear-gradient(135deg, var(--accent) 0%, #bf360c 100%);
            color: var(--paper);
...
<body>
    <nav class="global-nav">
        ...
        <div class="bu-selector">
            ...
            <a href="index.html" class="bu-link active">Kandy</a>
            <a href="../stl/index.html" class="bu-link">STL</a>
            <a href="../newnet/index.html" class="bu-link">NewNet</a>
        </div>
    </nav>

    <div class="header">
        <h1>Kandy Business Unit</h1>
    ...
    <div class="footer">
        ...
        <p style="margin-top: 0.5rem; opacity: 0.8;">Kandy Business Unit | Generated: {datetime.now().strftime('%B %Y')}</p>
    </div>
...
def main():
    ...
    with open('output/kandy/index.html', 'w') as f:
        f.write(html)

    print("="*100)
    print("✅ Kandy BU index page generated")
    print("📁 Saved to: output/kandy/index.html")
    print("="*100)
    print("\nOpen with: open output/kandy/index.html")
