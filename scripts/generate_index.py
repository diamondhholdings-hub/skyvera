"""Generate master index page with customer selector."""
import json
...
<body>
    ...
    <div class="footer">
        ...
        <p style="margin-top: 0.5rem; opacity: 0.8;">CloudSense Business Unit | Generated: {datetime.now().strftime('%B %Y')}</p>
    </div>
...
def main():
    ...
    print("="*100)
    print("✅ Master index page generated")
    print("📁 Saved to: output/index.html")
    print("="*100)
    print("\nOpen with: open output/index.html")
