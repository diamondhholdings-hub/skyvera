...
/**
 * Error boundary for account plan detail route
 * Handles API failures with user-friendly messaging
 */
export default function AccountPlanError({
  ...
  let userMessage = 'Something went wrong while loading account details'
