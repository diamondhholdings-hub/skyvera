# NOKIA SOLUTIONS AND NETWORKS OY - STRATEGIC ACCOUNT PLAN
...
**Account:** Nokia Solutions and Networks Oy
...
|--------|-------|
| **Current ARR** | $863,804 |
| **Quarterly Revenue** | $215,951 |
| **Recurring Revenue** | $215,951 |
...
**Nokia Solutions and Networks Oy** is a leading organization in the technology & software industry, operating primarily in Europe. The company has established itself as a significant player in its market segment, with estimated annual revenues of approximately $1M.

| Attribute | Detail |
|-----------|--------|
| **Legal Name** | Nokia Solutions and Networks Oy |
| **Industry** | Technology & Software |
| **Region** | Europe |
...
Nokia Solutions and Networks Oy operates in a competitive technology & software market that is undergoing significant digital transformation. Key market drivers include:
...
**Platform:** NewNet
**Contract Value:** $863,804 ARR
**Relationship Duration:** 1 years

The NewNet platform is integrated in Nokia Solutions and Networks Oy's operations, supporting critical business processes. The deployment has been successful with solid user adoption and business impact.
...
- **Revenue Impact:** Support for $17,276,089 in annual transaction value
