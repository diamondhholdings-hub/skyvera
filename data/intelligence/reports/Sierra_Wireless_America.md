# SIERRA WIRELESS AMERICA - STRATEGIC ACCOUNT PLAN
...
**Account:** Sierra Wireless America
...
|--------|-------|
| **Current ARR** | $417,217 |
| **Quarterly Revenue** | $104,304 |
| **Recurring Revenue** | $104,304 |
...
**Sierra Wireless America** is a leading organization in the telecommunications industry, operating primarily in Europe. The company has established itself as a significant player in its market segment, with estimated annual revenues of approximately $596K.

| Attribute | Detail |
|-----------|--------|
| **Legal Name** | Sierra Wireless America |
| **Industry** | Telecommunications |
| **Region** | Europe |
| **Estimated Revenue** | $596K |
| **Website** | https://www.sierra.com |

### 1.2 Business Context

Sierra Wireless America operates in a competitive telecommunications market that is undergoing significant digital transformation. Key market drivers include:
...
**Platform:** NewNet
**Contract Value:** $417,217 ARR
**Relationship Duration:** 5 years

The NewNet platform is integrated in Sierra Wireless America's operations, supporting critical business processes. The deployment has been successful with solid user adoption and business impact.
...
- **Revenue Impact:** Support for $8,344,334 in annual transaction value
...
**Estimated Value:** $657,462 ARR
**Probability:** 45%
**Timeline:** 9 months

Support digital transformation initiatives for B2B services This represents a natural evolution of the current deployment and aligns with Sierra Wireless America's strategic priorities.
