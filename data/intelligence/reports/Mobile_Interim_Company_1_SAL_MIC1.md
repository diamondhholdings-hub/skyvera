# MOBILE INTERIM COMPANY 1 S.A.L. (MIC1) - STRATEGIC ACCOUNT PLAN
...
**Account:** Mobile Interim Company 1 S.A.L. (MIC1)
**Status:** Active Customer
**Account Health Score:** 64/100

| Metric | Value |
|--------|-------|
| **Current ARR** | $1,111,500 |
| **Quarterly Revenue** | $277,875 |
| **Recurring Revenue** | $277,875 |
...
**Mobile Interim Company 1 S.A.L. (MIC1)** is a leading organization in the telecommunications industry, operating primarily in Europe. The company has established itself as a significant player in its market segment, with estimated annual revenues of approximately $2M.

| Attribute | Detail |
|-----------|--------|
| **Legal Name** | Mobile Interim Company 1 S.A.L. (MIC1) |
| **Industry** | Telecommunications |
| **Region** | Europe |
| **Estimated Revenue** | $2M |
| **Website** | https://www.mobile.com |

### 1.2 Business Context

Mobile Interim Company 1 S.A.L. (MIC1) operates in a competitive telecommunications market that is undergoing significant digital transformation. Key market drivers include:
...
**Platform:** NewNet
**Contract Value:** $1,111,500 ARR
**Relationship Duration:** 5 years

The NewNet platform is integrated in Mobile Interim Company 1 S.A.L. (MIC1)'s operations, supporting critical business processes. The deployment has been successful with solid user adoption and business impact.
...
- **Revenue Impact:** Support for $22,230,008 in annual transaction value
...
**Estimated Value:** $481,611 ARR
**Probability:** 58%
**Timeline:** 9 months

Support digital transformation initiatives for B2B services This represents a natural evolution of the current deployment and aligns with Mobile Interim Company 1 S.A.L. (MIC1)'s strategic priorities.
