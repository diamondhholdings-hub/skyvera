# ODIDO NETHERLANDS B.V. - STRATEGIC ACCOUNT PLAN
...
|--------|-------|
| **Current ARR** | $310,207 |
| **Quarterly Revenue** | $77,552 |
| **Recurring Revenue** | $77,552 |
...
**Odido Netherlands B.V.** is a leading organization in the enterprise services industry, operating primarily in Netherlands. The company has established itself as a significant player in its market segment, with estimated annual revenues of approximately $443K.

| Attribute | Detail |
|-----------|--------|
| **Legal Name** | Odido Netherlands B.V. |
| **Industry** | Enterprise Services |
| **Region** | Netherlands |
| **Estimated Revenue** | $443K |
| **Website** | https://www.odido.com |

### 1.2 Business Context

Odido Netherlands B.V. operates in a competitive enterprise services market that is undergoing significant digital transformation. Key market drivers include:
...
**Platform:** NewNet
**Contract Value:** $310,207 ARR
**Relationship Duration:** 2 years

The NewNet platform is integrated in Odido Netherlands B.V.'s operations, supporting critical business processes. The deployment has been successful with solid user adoption and business impact.
...
- **Revenue Impact:** Support for $6,204,150 in annual transaction value
