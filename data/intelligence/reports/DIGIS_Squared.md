# DIGIS SQUARED LIMITED - STRATEGIC ACCOUNT PLAN
...
|--------|-------|
| **Current ARR** | $318,926 |
| **Quarterly Revenue** | $79,732 |
| **Recurring Revenue** | $79,732 |
...
**DIGIS Squared Limited** is a leading organization in the enterprise services industry, operating primarily in Europe. The company has established itself as a significant player in its market segment, with estimated annual revenues of approximately $456K.

| Attribute | Detail |
|-----------|--------|
| **Legal Name** | DIGIS Squared Limited |
| **Industry** | Enterprise Services |
| **Region** | Europe |
| **Estimated Revenue** | $456K |
| **Website** | https://www.digis.com |

### 1.2 Business Context

DIGIS Squared Limited operates in a competitive enterprise services market that is undergoing significant digital transformation. Key market drivers include:
...
**Platform:** NewNet
**Contract Value:** $318,926 ARR
**Relationship Duration:** 5 years

The NewNet platform is integrated in DIGIS Squared Limited's operations, supporting critical business processes. The deployment has been successful with solid user adoption and business impact.
...
- **Revenue Impact:** Support for $6,378,521 in annual transaction value
