# NOKIA OPERATIONS DE MEXICO, SA DE CV - STRATEGIC ACCOUNT PLAN
...
**Account:** Nokia Operations de Mexico, SA de CV
...
|--------|-------|
| **Current ARR** | $378,872 |
| **Quarterly Revenue** | $94,718 |
| **Recurring Revenue** | $94,718 |
...
**Nokia Operations de Mexico, SA de CV** is a leading organization in the enterprise services industry, operating primarily in Latin America. The company has established itself as a significant player in its market segment, with estimated annual revenues of approximately $541K.

| Attribute | Detail |
|-----------|--------|
| **Legal Name** | Nokia Operations de Mexico, SA de CV |
| **Industry** | Enterprise Services |
| **Region** | Latin America |
| **Estimated Revenue** | $541K |
| **Website** | https://www.nokia.com |

### 1.2 Business Context

Nokia Operations de Mexico, SA de CV operates in a competitive enterprise services market that is undergoing significant digital transformation. Key market drivers include:
...
**Platform:** NewNet
**Contract Value:** $378,872 ARR
**Relationship Duration:** 2 years

The NewNet platform is integrated in Nokia Operations de Mexico, SA de CV's operations, supporting critical business processes. The deployment has been successful with solid user adoption and business impact.
...
- **Revenue Impact:** Support for $7,577,444 in annual transaction value
