# PROXIMUS NV - STRATEGIC ACCOUNT PLAN
...
| Metric | Value |
|--------|-------|
| **Current ARR** | $1,600,586 |
| **Quarterly Revenue** | $400,147 |
| **Recurring Revenue** | $400,147 |
...
**Proximus NV** is a leading organization in the enterprise services industry, operating primarily in United States. The company has established itself as a significant player in its market segment, with estimated annual revenues of approximately $2M.

| Attribute | Detail |
|-----------|--------|
| **Legal Name** | Proximus NV |
| **Industry** | Enterprise Services |
| **Region** | United States |
...
Proximus NV operates in a competitive enterprise services market that is undergoing significant digital transformation. Key market drivers include:
...
**Platform:** CloudSense
**Contract Value:** $1,600,586 ARR
**Relationship Duration:** 5 years

The CloudSense platform is integrated in Proximus NV's operations, supporting critical business processes. The deployment has been successful with solid user adoption and business impact.
...
- **Revenue Impact:** Support for $32,011,724 in annual transaction value
...
**Estimated Value:** $308,109 ARR
**Probability:** 43%
**Timeline:** 6 months

Expand CPQ footprint to additional product lines and business units This represents a natural evolution of the current deployment and aligns with Proximus NV's strategic priorities.
...
**Estimated Value:** $328,166 ARR
**Probability:** 62%
**Timeline:** 6 months

Implement advanced pricing and discounting automation This represents a natural evolution of the current deployment and aligns with Proximus NV's strategic priorities.
...
**Estimated Value:** $679,290 ARR
**Probability:** 65%
**Timeline:** 11 months

Integrate with ERP and billing systems for end-to-end quote-to-cash This represents a natural evolution of the current deployment and aligns with Proximus NV's strategic priorities.
