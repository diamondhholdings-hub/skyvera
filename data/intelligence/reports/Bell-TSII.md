# BELL-TSII LIMITED - STRATEGIC ACCOUNT PLAN
...
|--------|-------|
| **Current ARR** | $634,005 |
| **Quarterly Revenue** | $158,501 |
| **Recurring Revenue** | $158,501 |
...
**Bell-TSII Limited** is a leading organization in the enterprise services industry, operating primarily in Europe. The company has established itself as a significant player in its market segment, with estimated annual revenues of approximately $906K.

| Attribute | Detail |
|-----------|--------|
| **Legal Name** | Bell-TSII Limited |
| **Industry** | Enterprise Services |
| **Region** | Europe |
| **Estimated Revenue** | $906K |
| **Website** | https://www.belltsii.com |

### 1.2 Business Context

Bell-TSII Limited operates in a competitive enterprise services market that is undergoing significant digital transformation. Key market drivers include:
...
**Platform:** NewNet
**Contract Value:** $634,005 ARR
**Relationship Duration:** 4 years

The NewNet platform is integrated in Bell-TSII Limited's operations, supporting critical business processes. The deployment has been successful with solid user adoption and business impact.
...
- **Revenue Impact:** Support for $12,680,096 in annual transaction value
